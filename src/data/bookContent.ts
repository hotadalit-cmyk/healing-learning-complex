...
export const bookContent: Chapter[] = [
  ...
  },
  {
    ...
    content: `
      <p class="mb-6 leading-relaxed text-lg">Итак, карта мироздания лежит перед вами. Вы видели план этажей Реальности. Вы понимаете природу Вируса, заразившего систему. Вы получили доступ к антивирусным протоколам — Христу и Корану. Вы владеете ключом к синергии и знаете финальную цель — Обожение.</p>
